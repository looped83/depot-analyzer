  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-slate-100 dark:border-zinc-800 shadow-sm p-5">
        <h3 className="text-sm font-semibold text-slate-800 dark:text-zinc-200 mb-1">Erwarteter Cashflow je Monat</h3>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-slate-100 dark:border-zinc-800 shadow-sm p-5">
        <h3 className="text-sm font-semibold text-slate-800 dark:text-zinc-200 mb-4">Dividendenkalender – Zahler je Monat</h3>
